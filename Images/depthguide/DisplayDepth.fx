...
uniform bool bUIDither <
	ui_category = "Advanced settings";
	ui_label = "Dither the depth view";
	ui_tooltip = "Dithering is normally used to remove banding artifacts in the depth buffer. You can turn this off if you so desire";
> = true;
